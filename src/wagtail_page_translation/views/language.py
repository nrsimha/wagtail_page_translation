...
class Index(generic.IndexView):
    ...
    template_name = 'wagtail_page_translation/languages/index.html'
    add_url_name = 'wagtail_page_translation_languages:add'
...
class Create(generic.CreateView):
    ...
    add_url_name = 'wagtail_page_translation_languages:add'
    edit_url_name = 'wagtail_page_translation_languages:edit'
    index_url_name = 'wagtail_page_translation_languages:index'
    header_icon = 'folder-open-1'
...
class Edit(generic.EditView):
    ...
    edit_url_name = 'wagtail_page_translation_languages:edit'
    index_url_name = 'wagtail_page_translation_languages:index'
    delete_url_name = 'wagtail_page_translation_languages:delete'
    context_object_name = 'languages'
    header_icon = 'folder-open-1'
